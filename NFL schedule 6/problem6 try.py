...
for i in range(14):
    for t in ateam:
        constrName = '03b_No4ConsecuAway_{0}_during{1}_{2}'.format(t,i+1,i+4)
        ...
        constrName1 = '03b_No4ConsecuHome_{0}_during{1}_{2}'.format(t,i+1,i+4)
        Constrs[constrName]=foot.addConstr(quicksum(myVars[a,t,w,s,n] for a,t,w,s,n in season.select('*',t,week[i:i+4],'*','*'))<=3,name=constrName1) 
